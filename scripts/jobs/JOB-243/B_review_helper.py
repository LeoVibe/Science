#!/usr/bin/env python3
"""
JOB-243 Phase 2 普查複檢輔助 — B_review_helper.py
...
輸出：
  scripts/jobs/JOB-243/_review/{exam_id}.review.md
...
REVIEW_DIR = os.path.join(ROOT, 'scripts/jobs/JOB-243/_review')
L2_DIRS = [
...
def load_l2(exam_id):
    ...
    for sub in L2_DIRS:
        ...
        p2 = os.path.join(ROOT, sub, f'三下_國語_{exam_id}.json')

#!/usr/bin/env python3
"""
JOB-243 Phase 3 — E_kl4_teaching_examples.py
...
輸出：knowledge/3_考古題/3_L2_結構化抽取/三下/alignment/kl4_teaching_examples.md
"""
import json
import os
...
OUT_PATH = os.path.join(ROOT, 'knowledge/3_考古題/3_L2_結構化抽取/三下/alignment/kl4_teaching_examples.md')
...
def main():
    ...
    md.append("")
    md.append("# 三下_國語 KL4 教學示例報告 (Phase 3)")
    md.append("")

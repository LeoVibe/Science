#!/bin/bash
# JOB-243 Phase 1 Pilot dispatch（三下_國語，新版 5 份試跑）
# 三下改版年份：翰林 111→112 / 康軒 110→111 / 南一 110→111
...
OUT_DIR="knowledge/3_考古題/3_L2_結構化抽取/三下/alignment/_partial"
LOG_DIR="scripts/jobs/JOB-243/_phase1_logs"
PROMPT_TPL="scripts/jobs/JOB-243/A1_align_prompt_template.md"
L2_FULL_DIR="knowledge/3_考古題/3_L2_結構化抽取/三下/三下_國語_翰林"
L2_KH_DIR="knowledge/3_考古題/3_L2_結構化抽取/三下/三下_國語_康軒"
L2_NY_DIR="knowledge/3_考古題/3_L2_結構化抽取/三下/三下_國語_南一"
...
# 三下 Pilot 5 份固定清單（題數 ≥20 的典型試卷）
fixed = [
    ('翰林', '112', '三下_國語_翰林', '翰林_112_2_期末考'),
    ('翰林', '113', '三下_國語_翰林', '翰林_113_未知國小_期末考'),
    ('康軒', '111', '三下_國語_康軒', '康軒_111_安和國小_期中考'),
    ('康軒', '112', '三下_國語_康軒', '康軒_112_太平國小_第一次段考'),
    ('南一', '112', '三下_國語_南一', '南一_112_2_期末考'),
]
...
echo "=== JOB-243 Phase 1 Pilot start ==="
...
for path in sorted(glob.glob('knowledge/3_考古題/3_L2_結構化抽取/三下/alignment/_partial/alignment_partial_*.json')):
    try:
...
echo "  - 三下_國語 預期 R1 比例略低於四下（顯式引用較少），R3 比例會高"
echo ""

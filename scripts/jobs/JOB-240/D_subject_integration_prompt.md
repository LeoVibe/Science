# JOB-240 Phase D：五下_國語全科目整合 _L2_整合.md 派工 Prompt

> 此 prompt 在 Phase C（三份 _L2_summary.md）完成後，派 codex 寫全科目整合報告。

## 輸入

- `knowledge/3_考古題/3_L2_結構化抽取/五下/五下_國語_翰林/_L2_summary.md`
- `knowledge/3_考古題/3_L2_結構化抽取/五下/五下_國語_康軒/_L2_summary.md`
- `knowledge/3_考古題/3_L2_結構化抽取/五下/五下_國語_南一/_L2_summary.md`
...
---
`last_updated`: <ISO 時間>
`updated_by`: Codex (gpt-5.5) - JOB-240 Phase D
`scope`: 五下_國語（翰林+康軒+南一）
`total_files`: 115
`total_questions`: <int>
`total_codes`: <int>
---
...
本檔以三份版本級 `_L2_summary.md` 為主，並以 `_validation_report_chinese_g5.json` 中五下_國語三版本的 `per_file` 切片核對總題數與 codes 數。

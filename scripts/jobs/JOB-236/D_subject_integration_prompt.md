# JOB-236 Phase D：六下_自然全科目整合 _L2_整合.md 派工 Prompt

> 此 prompt 在 Phase C（三份 _L2_summary.md）完成後，派 codex 寫全科目整合報告。

## 輸入

- `knowledge/3_考古題/3_L2_結構化抽取/六下/六下_自然_翰林/_L2_summary.md`
- `knowledge/3_考古題/3_L2_結構化抽取/六下/六下_自然_康軒/_L2_summary.md`
- `knowledge/3_考古題/3_L2_結構化抽取/六下/六下_自然_南一/_L2_summary.md`
- `knowledge/3_考古題/3_L2_結構化抽取/_validation_report_natural_g6.json`

## 輸出

`knowledge/3_考古題/3_L2_結構化抽取/六下/六下_自然_L2_整合.md`
...
---
`last_updated`: <ISO 時間>
`updated_by`: Codex (gpt-5.5) - JOB-236 Phase D
`scope`: 六下_自然（翰林+康軒+南一）
`total_files`: 120
`total_questions`: <int>
`total_codes`: <int>
---
...
本檔以三份版本級 `_L2_summary.md` 為主，並以 `_validation_report_natural_g6.json` 中六下自然三版本的 `per_file` 切片核對總題數與 codes 數。

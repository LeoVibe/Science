#!/usr/bin/env python3
"""
JOB-245 Phase 3 — D_kl3_coverage_report.py
...
輸出：knowledge/3_考古題/3_L2_結構化抽取/六下/alignment/kl3_coverage_report.md
"""
import json
import os
...
OUT_PATH = os.path.join(ROOT, 'knowledge/3_考古題/3_L2_結構化抽取/六下/alignment/kl3_coverage_report.md')
...
def main():
    ...
    md.append("")
    md.append("# 六下_國語 KL3 課次覆蓋報告 (Phase 3)")
    md.append("")

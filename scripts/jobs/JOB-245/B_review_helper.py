#!/usr/bin/env python3
"""
JOB-245 Phase 2 普查複檢輔助 — B_review_helper.py
...
輸出：
  scripts/jobs/JOB-245/_review/{exam_id}.review.md
...
REVIEW_DIR = os.path.join(ROOT, 'scripts/jobs/JOB-245/_review')
L2_DIRS = [
    'knowledge/3_考古題/3_L2_結構化抽取/_golden_samples',
    'knowledge/3_考古題/3_L2_結構化抽取/六下/六下_國語_pilot',
...
def load_l2(exam_id):
    ...
    for sub in L2_DIRS:
        ...
        p2 = os.path.join(ROOT, sub, f'六下_國語_{exam_id}.json')

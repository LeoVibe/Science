#!/usr/bin/env python3
"""
JOB-242 Phase 2 普查複檢輔助 — B_review_helper.py
...
輸出：
  scripts/jobs/JOB-242/_review/{exam_id}.review.md
...
REVIEW_DIR = os.path.join(ROOT, 'scripts/jobs/JOB-242/_review')
L2_DIRS = [
    'knowledge/3_考古題/3_L2_結構化抽取/_golden_samples',
    'knowledge/3_考古題/3_L2_結構化抽取/四下/四下_國語_pilot',
    'knowledge/3_考古題/3_L2_結構化抽取/四下/四下_國語_翰林',
    'knowledge/3_考古題/3_L2_結構化抽取/四下/四下_國語_康軒',
    'knowledge/3_考古題/3_L2_結構化抽取/四下/四下_國語_南一',
]
...
def load_l2(exam_id):
    ...
    for sub in L2_DIRS:
        ...
        p2 = os.path.join(ROOT, sub, f'四下_國語_{exam_id}.json')

"""Task 6 全量 build targets：排除 Pilot 已完成 24 份，剩 ~94 份 dispatch。

跟 A1b_build_targets.py 不同：
- 不限 QUOTA，全 publisher 全 grab
- 不限 MAX_PILOT_QUESTIONS（全量需處理所有規模）
- 排除已完成（_partial 中沒有 N1_pending / N2_or_N3_pending）
- 仍按 publisher 分 3 worker file（保留並行架構）
"""

# JOB-244 Phase 1：L2 ↔ KL3/KL4 自動對齊（五下_國語，spec v1.1）

你是 Codex（gpt-5.5），負責對單一試卷做 L3 對齊。

> **JOB-244 重點**：本試卷已預先篩選為「新版（current）」範圍：
> - 翰林：112 學年（111 及以前為舊版，已排除）
> - 康軒：112 學年（111 及以前為舊版，已排除）
> - 南一：112-113 學年（111 及以前為舊版，已排除）
>
> 五下三家都 **111→112 改版**（巧合一致）。改版年份「不同年級不同」：四下翰林 110→111、三下翰林 111→112、五下三家都 111→112。
...
4. **KL4 單課研究紀錄（36 份，含 RC-01 課文）**：
   - `knowledge/1_課綱研究/國語/五下/翰林/KL4_五下_翰林_L*_單課研究紀錄.md`（12 份）
   - `knowledge/1_課綱研究/國語/五下/康軒/KL4_五下_康軒_L*_單課研究紀錄.md`（12 份）
   - `knowledge/1_課綱研究/國語/五下/南一/KL4_五下_南一_L*_單課研究紀錄.md`（12 份）
...
```json
{
  "_meta": {
    ...
    "extractor": "Codex (gpt-5.5) - JOB-244 Phase 1",
    "total_questions": <int>
  },
  "l2_to_kl_links": [
    {
      ...
      "kl3_links": [
        {
          ...
          "evidence": "題幹中『鵝鑾鼻詩』一詞與第二段引用"
        }
      ],
      "kl4_links": [
        {
          "kecode": "0150201",
          "kl3_anchor": "kl3-0150201-XXXXXXXXXX",
          "rc01_evidence": true,
          "rc01_quote": "燈塔是一座發光體，海是一串永不休止的音符"
        }
      ],
...
9. **version_match 必填**（v1.1 新增）：
   ...
   - 若題幹意外引用**五下舊版專屬課文**（清單見下方），標 `version_match: "legacy"` + `legacy_lesson_title` 填課文名 + `kl4_links` 為空陣列
...
### 五下舊版專屬課文（v1.1 黑名單 — JOB-244 Phase 0 驗證所得）

避免誤對齊到 KL4 kecode，本清單只用作識別 + 標 legacy，不對齊：

| Publisher | 舊版年份範圍 | 已知舊版專屬課文 |
|:--|:--|:--|
| 翰林（五下）| 108-111 | 宮崎駿的想像之泉、羅伯特換腦袋、歡慶兒童節、美麗的溫哥華、給女兒的一封信、從空中看地球 |
| 康軒（五下）| 108-111 | 天鵝湖、大石頭、胡桃鉗、池上日記、訊息轉發｜停看聽、飯包哲學、湖濱散記、名人記趣 |
| 南一（五下）| 108-111 | 鬥牛圖、小兔彼得和波特小姐、為一本書留一種味道、凝聚愛的每一哩路、一針一線縫進母愛 |
...
- [ ] kl4_links 課碼格式正確（7 碼，版本碼對，年級為 5）

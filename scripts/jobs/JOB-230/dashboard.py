#!/usr/bin/env python3
"""JOB-230 Phase 5 整合 Dashboard（吃 worker A/B/C 三份 progress + targets）"""
...
def print_text(summary: dict) -> None:
    ...
    print(top_border())
    print(box_line('  📊 JOB-230 Phase 5 進度儀表板（並行 3 worker）'))
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='JOB-230 Phase 5 整合進度儀表板')

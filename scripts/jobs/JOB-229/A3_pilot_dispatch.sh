#!/bin/bash
# JOB-229 Phase 0.3 Pilot 5 份 dispatch
# 並行 3 條 codex 跑（避免一次 5 條過載；剩餘 2 條等前批完成）
# 對齊黃金樣本 schema：knowledge/3_考古題/3_L2_結構化抽取/_golden_samples/翰林_112_成功國小_第一次段考.json

set -u

OUT_DIR="knowledge/3_考古題/3_L2_結構化抽取/三下/三下_自然_pilot"
LOG_DIR="scripts/jobs/JOB-229/_pilot_logs"
PROMPT_TPL="scripts/jobs/JOB-229/A2_pilot_prompt_template_natural.md"
...
PILOT_LIST=(
  "南一_108_永光國小_第一次段考|knowledge/3_考古題/2_MD淬鍊文字_整合版/三下/三下_自然_南一/南一_108_永光國小_第一次段考.md|dual_source+full"
  "康軒_108_興南國小_第二次段考|knowledge/3_考古題/2_MD淬鍊文字_整合版/三下/三下_自然_康軒/康軒_108_興南國小_第二次段考.md|dual_source+full"
  "南一_108_中正國小_第一次段考|knowledge/3_考古題/2_MD淬鍊文字_整合版/三下/三下_自然_南一/南一_108_中正國小_第一次段考.md|dual_source+full"
  "康軒_109_伸東國小_第一次段考|knowledge/3_考古題/2_MD淬鍊文字_整合版/三下/三下_自然_康軒/康軒_109_伸東國小_第一次段考.md|dual_source+partial"
  "南一_108_成功國小_第二次段考|knowledge/3_考古題/2_MD淬鍊文字_整合版/三下/三下_自然_南一/南一_108_成功國小_第二次段考.md|claude_only+full"
)
...
build_prompt() {
  ...
  # 讀 prompt template，做 placeholder 替換
...
total_violations = 0
for path in sorted(glob.glob('knowledge/3_考古題/3_L2_結構化抽取/三下/三下_自然_pilot/*.json')):
    try:

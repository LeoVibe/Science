...
const R4_MAPPING = {
    'Chinese': {
        ...
        'G4/S2': path.join('四下', 'KL3_四下_國語_研究總綱.md'),
        'G5/S2': path.join('五下', 'KL3_五下_國語_研究總綱.md'),
        'G6/S2': path.join('六下', 'KL3_六下_國語_研究總綱.md')
    },
    'SocialStudies': {
        'G3/S2': 'KL3_三下_社會_研究總綱.md',
        'G4/S2': 'KL3_四下_社會_研究總綱.md',
        'G5/S1': 'KL3_五上_社會_研究總綱.md',
        'G5/S2': 'KL3_五下_社會_研究總綱.md',
        'G6/S2': 'KL3_六下_社會_研究總綱.md'
    },
    'Math': {
        'G3/S1': 'KL3_三上_數學_研究總綱.md',
        'G3/S2': 'KL3_三下_數學_研究總綱.md',
        'G4/S2': 'KL3_四下_數學_研究總綱.md',
        'G5/S1': 'KL3_五上_數學_研究總綱.md',
        'G5/S2': 'KL3_五下_數學_研究總綱.md',
        'G6/S2': 'KL3_六下_數學_研究總綱.md'
    },
    'English': {
        'G3/S2': 'KL3_三下_英語_研究總綱.md',
        'G4/S2': 'KL3_四下_英語_研究總綱.md',
        'G5/S2': 'KL3_五下_英語_研究總綱.md'
    },
    'Science': {
        'G3/S2': 'KL3_三下_自然_研究總綱.md',
        'G4/S2': 'KL3_四下_自然_研究總綱.md',
        'G5/S1': 'KL3_五上_自然_研究總綱.md',
        'G5/S2': 'KL3_五下_自然_研究總綱.md',
        'G6/S2': 'KL3_六下_自然_研究總綱.md'
    }
};

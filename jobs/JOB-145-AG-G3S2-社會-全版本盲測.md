...
## 📖 執行目錄
  ...
  - `question/platform/G3/SocialStudies/S2/HanLin` — 180 題，6 課
  - `question/platform/G3/SocialStudies/S2/KangHsuan` — 144 題，6 課
  - `question/platform/G3/SocialStudies/S2/NanYi` — 105 題，5 課
...
- [ ] 產出 `jobs/JOB-145-Report.md`（Cursor 撰寫）

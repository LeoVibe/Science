...
**前置完成**：
- JOB-168：KL4 單課研究檔已建置（`knowledge/課綱研究/自然/四下/{康軒,翰林,南一}/`）
...
研究素材：
- `knowledge/課綱研究/自然/四下_自然_發展綱要.md`（KL3）
- `knowledge/課綱研究/自然/四下/{出版社}/KL4_四下_{出版社}_L{N}_{課名}_單課研究紀錄.md`（KL4，JOB-168 產出）
- `knowledge/課綱研究/自然/G4_S2_自然_原始研究素材庫.md`
...
| `knowledge/課綱研究/自然/四下_自然_發展綱要.md` | KL3 課綱 |

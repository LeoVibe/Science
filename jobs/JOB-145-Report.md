...
| 維度 | 滿分 | 本次得分 | 說明（摘要） |
|:--|:--:|:--:|:--|
| **V-F** 課綱對齊度 | 1.5 | **1.5** | 本批皆為 G3 下學期社會；盲測腳本已載入 `knowledge/1_課綱研究/社會/G3_S2_社會發展綱要.md` 並逐課 LLM 萃取；題幹多為家庭／學校／社區情境，與中年級社會主題一致。（若需逐課「單課研究紀錄＋核心關鍵字矩陣」之 0.75 細拆，可併入後續修題覆核。） |

# codex補題：三下社會南一 L3《生活理財》補 7 題

你是國小三年級社會出題老師。為 L3 補 7 題，嚴格對應考古考點。

## 必讀
1. 考點清單 `jobs/_goal-work/SOC_NanYi/L3_kaodian.json`
2. 格式範本 `jobs/_goal-work/SOC_NanYi/L3_template.json`
...
## 輸出
純JSON陣列(無圍欄)寫入 `jobs/_goal-work/SOC_NanYi/L3_supplement.json`，共 7 題。

# codex補題：三下社會康軒 L2《居住地方的風貌》補 5 題

你是國小三年級社會出題老師。為 L2 補 5 題，嚴格對應考古考點。

## 必讀
1. 考點清單 `jobs/_goal-work/SOC_KangHsuan/L2_kaodian.json`
2. 格式範本 `jobs/_goal-work/SOC_KangHsuan/L2_template.json`
...
## 輸出
純JSON陣列(無圍欄)寫入 `jobs/_goal-work/SOC_KangHsuan/L2_supplement.json`，共 5 題。

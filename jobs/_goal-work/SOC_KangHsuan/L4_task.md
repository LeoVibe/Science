# codex補題：三下社會康軒 L4《消費與選擇》補 8 題

你是國小三年級社會出題老師。為 L4 補 8 題，嚴格對應考古考點。

## 必讀
1. 考點清單 `jobs/_goal-work/SOC_KangHsuan/L4_kaodian.json`
2. 格式範本 `jobs/_goal-work/SOC_KangHsuan/L4_template.json`
...
## 輸出
純JSON陣列(無圍欄)寫入 `jobs/_goal-work/SOC_KangHsuan/L4_supplement.json`，共 8 題。

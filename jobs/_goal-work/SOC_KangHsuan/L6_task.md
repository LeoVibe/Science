# codex補題：三下社會康軒 L6《家鄉的探索》補 9 題

你是國小三年級社會出題老師。為 L6 補 9 題，嚴格對應考古考點。

## 必讀
1. 考點清單 `jobs/_goal-work/SOC_KangHsuan/L6_kaodian.json`
2. 格式範本 `jobs/_goal-work/SOC_KangHsuan/L6_template.json`
...
## 輸出
純JSON陣列(無圍欄)寫入 `jobs/_goal-work/SOC_KangHsuan/L6_supplement.json`，共 9 題。

...
### Phase 1: 準備
1. 讀取 `knowledge/1_課綱研究/國語/五下/[版本]/KL4_*_單課研究紀錄.md`
2. 讀取 `knowledge/1_課綱研究/國語/五下/[版本]/KL4_*_考古題與討論.md`
...
| 檔案路徑 | 用途 |
|:--|:--|
| `knowledge/1_課綱研究/國語/五下/[版本]/KL4_*.md` | 出題素材來源（研究紀錄 + 考古題） |
| `knowledge/1_課綱研究/國語/五下/KL4_五下_國語_原始研究素材庫.md` | 三版本課文清單與 R3 考點 |

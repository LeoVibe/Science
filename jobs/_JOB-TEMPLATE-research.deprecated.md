...
> 本模板已廢棄。使用 R3/R4 舊術語，不符合 KL2/KL3/KL4 現行架構，且缺少量化 DoD、歷史卡點防範與 α/β+ 路徑設計。
>
> **請改用**：
> - KL3 研究任務 → `jobs/_JOB-TEMPLATE-research-KL3.md`
> - KL4 研究任務 → `jobs/_JOB-TEMPLATE-research-KL4.md`
>
> 本檔保留供歷史追溯，不得用於建立新 JOB。

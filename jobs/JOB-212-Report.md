...
### Phase D2（2026-04-29 結案）

盤點後確認 per-lesson KL4 雙檔已由前序 JOB（JOB-102 bootstrap_kl4 等）建立：
- 三下/四下/五下：各 36 對（翰林/康軒/南一 × L1-L12）
- 六下：33 對（各出版社 11 課）

4 份國語年度素材庫大檔（課名清單 + 待補充佔位符）確認已無額外有效內容，刪除：
- ~~`KL4_三下_國語_原始研究素材庫.md`~~（已刪除 2026-04-29）
- ~~`KL4_四下_國語_原始研究素材庫.md`~~（已刪除 2026-04-29）
- ~~`KL4_五下_國語_原始研究素材庫.md`~~（已刪除 2026-04-29）
- ~~`KL4_六下_國語_原始研究素材庫.md`~~（已刪除 2026-04-29）

後續：三下_國語_翰林 現有 27 份可用考古題 MD（28K~248K 字/份），另三下_社會 共 81 份可用，以新 JOB 處理 KL4 考古題與討論重建。

## 📌 遺留問題（已轉交新 JOB）

- **三下 KL4 考古題重建**：以新增的考古題 MD 更新 KL4_三下_*_考古題與討論.md，含國語翰林 27 份、社會翰林/康軒 81 份。指派至新 JOB-216（待開立）。

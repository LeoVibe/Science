...
- β+ 補償研究法方法論文件化（`knowledge/5_學習議題研究/無課文情境的考古題補償研究法.md`）
- α / β+ 雙軌路徑納入研究架構總綱
- G3 社會南一 L5 首個 β+ pilot 成功（CQI 9.19 / Match 100%）

### 🔑 新核心原則（修訂既有規範）

**「所有下載的原始檔永久保留」** — 覆寫既有 `knowledge/3_考古題/README §一 Rule 7`（原「解析完成即刪 PDF」）。
...
1. **建立標準化「考古」目錄結構**：`knowledge/3_考古題/{_manifest,原始,淬煉}/G{1-6}/{學期_科目}/`
...
6. **更新所有文件引用**（使用者 Q3=A）：改 `knowledge/3_考古題/` → `knowledge/3_考古題/` 全部 broken link 修正
...
- 目錄結構建立與既有檔案遷移
- 下載 / 淬煉腳本開發
- 規範文件更新（`knowledge/3_考古題/README.md`）
- `.gitignore` 調整
...
```
knowledge/3_考古題/                                  ← 新主目錄（從 考古題原檔 rename）
...
| `knowledge/5_學習議題研究/無課文情境的考古題補償研究法.md` | β+ 方法論（本 JOB 的研究基礎） |
| `knowledge/3_考古題/_manifest/pdf_manifest_G1_G6.json` | 11,704 PDF 全站清單（遷移到 `knowledge/3_考古題/_manifest/`） |
| `knowledge/1_課綱研究/社會/三下/南一/KL4_三下_南一_L5_*.md` | Pilot 的 KL4 雙檔（參照範本） |
...
- [ ] Phase 5：grep `knowledge/3_考古題` 全站改完（0 broken reference）
- [ ] `.gitignore` 更新：新路徑生效

## ✅ 成果 Checklist (Deliverables)

- [ ] `knowledge/3_考古題/README.md` 新規範

...
### 三下社會 6 課新題（替換 BIAS 用）
| 課 | quality | cqi | 認知配比 | BIAS | 答案分布 |
|:--|:--|:--|:--|:--|:--|
| 康軒 L2/L4/L5 | QL4 | 9.20 | 20/20/10（4:4:2）| None | 12-13 均勻 |
| 南一 L1/L3/L4 | QL4 | 9.14-9.20 | 20/20/10 | None | 12-13 均勻 |

### 三下社會 11 課保留舊版
- 翰林 L1-L6：QL4，cqi 7.88-8.60，bias=None
- 康軒 L1/L3/L6：QL4，cqi 8.28-8.64，bias=None
- 南一 L2/L5：QL4，cqi 8.13-9.19，bias=None

→ **三下社會替換後 17 課全 QL4、無 BIAS、認知配比達標、答案分布均勻**

### 五下社會 10 課
| 版本 | quality | cqi 範圍 | BIAS |
|:--|:--|:--|:--|
| 康軒 L1-L5 | QL4 | 8.34-8.71 | None |
| 南一 L1-L5 | QL4 | 8.25-8.83 | None |

→ 全 QL4 無 BIAS（注：cqi 為盲測加分後；底層 CQI-P 6.2-6.8 屬中等，內容深度一般但達上架標準）

### 已知瑕疵（不阻擋上架，建議後續補）
- **五下社會 4 題題幹空白**（康軒 L4 id39/40、南一 L4 id24/25）：question 欄為空字串，已標 pending（is_publishable=false），不影響整課顯示。建議補題幹後可上架。
- **三下社會無題幹空白、無內容重複**（檢查通過）。

### 驗證方法
- evaluate_question_quality.js 逐課（quality/cqi/認知配比/BIAS/答案分布）
- 題幹空白掃描、選項重複掃描、選項數（皆 4 選項）
- 雙盲：出題 Codex gpt-5.5／盲測 claude-opus-4-8

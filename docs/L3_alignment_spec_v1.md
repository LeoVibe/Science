...
*Updated at 2026-05-22 21:30 — 補三下_國語 三版本改版年份表（JOB-243 Phase 0）*
*Updated at 2026-05-23 00:30 — 補五下_國語 三版本改版年份表（JOB-244 Phase 0）*

`last_updated`: 2026-05-23 00:30
...
| Publisher | 改版分界 | 舊版（legacy）| 新版（current）| 證據 |
|:--|:--|:--|:--|:--|
| 翰林（四下_國語）| 110 → 111 | 108-110 | 111+ | 110 「好友籃球隊」舊版獨有 |
| 康軒（四下_國語）| 暫未發現改版（L1/L2/L4 跨年一致）| — | 108+（全部視為 current）| — |
| 南一（四下_國語）| 暫未發現改版 | — | 108+（全部視為 current）| — |
| 翰林（三下_國語）| 111 → 112 | 108-111 | 112+ | 111「清明」(杜牧古詩)舊版獨有；112「飛行員和小王子」「兩兩在一起」「兔子洞」current 命中 |
| 康軒（三下_國語）| 110 → 111 | 108-110 | 111+ | 108「追風車隊」舊版獨有；111「許願」「下雨的時候」「工匠之祖」current 命中 |
| 南一（三下_國語）| 110 → 111 | 108-110 | 111+ | 108「蚊子博士」舊版獨有；111「井仔腳鹽田」「枯木是大飯店」「三峽老街樂藍染」current 命中 |
| 翰林（五下_國語）| 111 → 112 | 108-111 | 112+ | 111「宮崎駿的想像之泉」「羅伯特換腦袋」「美麗的溫哥華」「給女兒的一封信」舊版獨有；112 current hit=42 大幅躍升 |
| 康軒（五下_國語）| 111 → 112 | 108-111 | 112+ | 111「大石頭」「湖濱散記」舊版；110「池上日記」「訊息轉發｜停看聽」「飯包哲學」舊版；112 current hit=64 |
| 南一（五下_國語）| 111 → 112 | 108-111 | 112+ | 111「鬥牛圖」舊版獨有；112/113 全 current 命中（紅鼻子醫生/魔術師爸爸/穿越時空的味道等）|

> 四下翰林舊版完整 12 課對應表見 `docs/archive/翰林舊版四下國語_課程對應表.md`。
> 三下舊版獨有課名快速名單（已內部驗證）：
> - 翰林三下：清明（杜牧）、其他古詩/閱讀測驗外部選文（111 前）
> - 康軒三下：追風車隊（108）
> - 南一三下：蚊子博士（108）
> 後續 cells（自然/社會、G5/G6）若發現改版，需補建對應的「舊版課程對應表」於同 archive 目錄。

**重要：改版年份「不同年級不同」**。四下翰林 110→111 但三下翰林 111→112；四下康軒/南一 全新版但三下康軒/南一 110→111。每個 cell 必須單獨驗證改版分界。
